...
export const generateGlossary = async (
  ...
  const prompt = `
    You are an expert academic research assistant and translator. 
    ...
    CRITICAL INSTRUCTION: All outputs (the 'term', the 'definition', and the 'context') MUST be written entirely in ${language}. 
    If the text is in English but the requested language is Japanese, you MUST translate the term, definition, and context to Japanese.
